...
Describe the subsystems of your apps in your source-code and let Siostam put it into graphs and high-level documentations. It's intended as an entry point documentation. It acts as a portal for the specialised docs (autogenerated, like Doxygen/JavaDoc/RustDoc, or not, like readthedocs). Siostam search for subsystems' files in your git repos and display it like this:
...
You may have passwords on your repositories, or you may want to change the port. This stuff can be changed in `.env` o in environment variables:
